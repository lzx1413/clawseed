...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/user/Documents/clawseed/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to ClawSeed tool names.
...
/// to. This function encodes the mapping for known ClawSeed tools.
...
pub fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. ClawSeed tool-call tags (<tool_call>, <toolcall>, <tool-call>)
...
Let me check the result."#;
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Additional parser internals tests (moved from agent crate to keep
