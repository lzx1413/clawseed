...
mod tests {
    ...
    // TODO: Re-enable once Config::save() writes to disk (currently a no-op stub).
    // #[tokio::test]
    ...
    //     assert!(
    //         clawseed_agent::security::SecretStore::is_encrypted(on_disk),
    ...
    // TODO: Re-enable once handle_nextcloud_talk_webhook, NextcloudTalkChannel,
    // verify_whatsapp_signature, and Bytes are available in clawseed-gateway
    // (ported).
    //
