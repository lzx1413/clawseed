...
mod tests {
    ...
    // Arc<ModelAwareMock> Provider impl provided by blanket impl in clawseed-api.
    ...
    // Arc<NativeModelAwareMock> Provider impl provided by blanket impl in clawseed-api.
    ...
    // Arc<StreamingToolEventMock> Provider impl provided by blanket impl in clawseed-api.
