...
mod tests {
    ...
    async fn test_pow() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "pow", "a": 2.0, "b": 10.0}), &test_ctx())
            .await
            .unwrap();
        assert!(result.success);
    ...
    async fn test_sqrt() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "sqrt", "x": 144.0}), &test_ctx())
            .await
            .unwrap();
        assert!(result.success);
    ...
    async fn test_sqrt_negative() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "sqrt", "x": -4.0}), &test_ctx())
            .await
            .unwrap();
        assert!(!result.success);
    }
    ...
    async fn test_abs() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "abs", "x": -42.5}), &test_ctx())
            .await
            .unwrap();
        assert!(result.success);
    ...
    async fn test_log_base10() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "log", "x": 100.0}), &test_ctx())
            .await
            .unwrap();
        assert!(result.success);
        assert_eq!(result.output, "2");
    ...
    async fn test_ln() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "ln", "x": 1.0}), &test_ctx())
            .await
            .unwrap();
        assert!(result.success);
    ...
    async fn test_exp() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "exp", "x": 0.0}), &test_ctx())
            .await
            .unwrap();
        assert!(result.success);
    ...
    async fn test_factorial() {
        let tool = CalculatorTool::new();
        let result = tool
            .execute(json!({"function": "factorial", "x": 5.0}), &test_ctx())
            .await
            .unwrap();
        assert!(result.success);
